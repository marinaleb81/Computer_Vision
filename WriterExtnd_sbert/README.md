...
* **Лучшая средняя точность (accuracy) на кросс-валидации (`k`-fold):** `[87%]`
...
* Подход, основанный на эмбеддингах SBERT (`sberbank-ai/sbert_large_nlu_ru`) и классификаторе `LinearSVC`, показал работоспособность и достиг точности `[87%]` на кросс-валидации обучающих данных.
